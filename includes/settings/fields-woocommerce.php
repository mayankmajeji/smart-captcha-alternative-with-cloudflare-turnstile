 ...
 *
 * @package SmartCT
 * @subpackage SmartCT/includes/settings
 */
...
return array(
	'woocommerce' => array(
		...
		'fields' => array(
			...
			'smartct_woo_checkout_position' => array(
				'type' => 'select',
				...
				'dependency' => array(
					'field' => 'smartct_woo_checkout',
					'value' => true,
				),
			),
			'smartct_woo_login' => array(
				'type' => 'checkbox',
			...
			'smartct_excluded_payment_methods' => array(
				'type' => 'multiselect',
